...
const copiers = {}
copiers.argument = (a, b) => copy(a, b)
copiers.bound = (a, b) => a::copy(b)

const describer = {}
describer.argument = `copy(a, b)`
describer.bound = `a::copy(b)`

describe('copy()', () => {

  for (const method in copiers) {

    const copier = copiers[method]
