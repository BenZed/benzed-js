...
import { isClient, isMobile, isEvent, storage, Cloner, CssCloner, Portal, Styler, $ } from './util'
...
export {
  ...
  // Util
  isClient, isEvent, isMobile, storage, Cloner, CssCloner, Portal, Color, Styler, $
